create or replace procedure usp_rh_saldo_disponible_cts (
...
delete from tt_saldo_disponible_cts ;
...
--  Inserta registro de saldo disponible de C.T.S.
insert into tt_saldo_disponible_cts (
  codigo, importe )
values (
  as_cod_trabajador, nvl(ln_saldos,0) ) ;
  
end usp_rh_saldo_disponible_cts ;
/
