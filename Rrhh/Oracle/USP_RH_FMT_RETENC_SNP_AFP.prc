...
ls_flag_tipo_remun        rrhh_fmt_remun_retenc.flag_tipo_retencion%type ;
...
FOR c_tra IN c_trabajador LOOP
    ...
    IF as_tipo = 'S' THEN
       ...
       ls_flag_tipo_remun := 'S' ;
       ln_remuneracion := USF_RH_REMUNER_SNP_AFP(an_periodo, as_origen,  c_tra.cod_trabajador, ls_flag_tipo_remun) ;
