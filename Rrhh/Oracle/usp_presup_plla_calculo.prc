create or replace procedure usp_presup_plla_calculo (
...
delete from presupuesto_partida pp
  where pp.ano = an_periodo and
        substr(pp.descripcion,1,23) = 'PRESUPUESTO DE PLANILLA' ;
...
while c_costos%found loop
  ...
  insert into presupuesto_partida (
    ...
    cod_usr )
  values (
    an_periodo, ls_cencos, ls_cuenta, 'PRESUPUESTO DE PLANILLA', ' ',
    0, '1', '3', 'E', '1',
