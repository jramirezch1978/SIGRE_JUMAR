create or replace procedure usp_rh_fmt_eval_pers_area (
  as_cod_area area.cod_area%type ) is

ls_nombre_trabajador     varchar2(120) ;
ls_nombre2               maestro.nombre2%type ;
  
--  Lectura de cargos reales por areas
cursor c_evaluacion_cab( as_cod_area char ) is 
  ...
  where cr.cod_area = as_cod_area and cr.flag_estado = '1' and
        cr.cod_trabajador = m.cod_trabajador and cr.cod_area = a.cod_area and
...
--  Lectura de cargos y competencias
...
--  *******************************************************
--  ***  REPORTE DE FROMATO DE EVALUACIONES POR AREAS   ***
--  *******************************************************
