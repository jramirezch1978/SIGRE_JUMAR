create or replace procedure usp_rpt_comp_sobretiempo_t
...
Cursor c_maestro is
  ...
  Where m.flag_estado = '1' and
        m.cod_trabajador = as_codtra ;
                
Cursor c_consolidado_diario is 
  Select mcd.carnet_trabajador, mcd.fecha_marcacion, mcd.hora_sobretiempo
...
delete from tt_comp_sobretiempo ;
...
For rc_mae in c_maestro loop
  ...
  For rc_con in c_consolidado_diario loop
    ...
    ln_horas_reloj := rc_con.hora_sobretiempo ;
  ...
  For rc_inc in c_incidencias loop
    ...
    If substr(ls_concepto,1,2) = '11' or substr(ls_concepto,1,2) = '12' then
      ...
      Insert into tt_comp_sobretiempo (
      ...
      Values (
        ...
        ld_fecha_hasta, ln_horas_digitado ) ;
...
End usp_rpt_comp_sobretiempo_t ;
/
