create or replace procedure usp_rpt_marc_det_regular
...
--  Genera archivo temporal de MARCACIONES REGULARES
For rc_con in c_consolidado_diario loop
  ...
  --  Determina numero de marcaciones regulares
  ...
  If ln_graba = 0 then
    ...
    For rc_mar in c_marcacion_reloj loop
      ...
      --  Inserta registros con marcaciones regulares
