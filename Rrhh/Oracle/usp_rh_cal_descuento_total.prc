create or replace procedure usp_rh_cal_descuento_total (
  asi_codtra          in maestro.cod_trabajador%TYPE, 
  adi_fec_proceso     in date, 
  asi_origen          in origen.cod_origen%TYPE,
  asi_total_dscto     in char,
...
begin
  ...
  --  **************************************************************
  --  ***   REALIZA SUMATORIA DE LOS DESCUENTOS POR TRABAJADOR   ***
  --  **************************************************************
  ...
  insert into calculo (
         ...
         tipo_planilla )
  values (
         asi_codtra, asi_total_dscto, adi_fec_proceso, 0, 0,
         0, ln_imp_soles, ln_imp_dolar, asi_origen, '1', 1,
         asi_tipo_planilla ) ;

end usp_rh_cal_descuento_total ;
/
