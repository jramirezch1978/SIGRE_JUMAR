create or replace procedure usp_rh_cal_licencia_sindical (
...
--  *********************************************************
--  ***   REALIZA CALCULO POR DIAS DE LICENCIA SINDICAL   ***
--  *********************************************************

select c.licencia_sindical into lk_ganancias_fijas
...
end usp_rh_cal_licencia_sindical ;
/
