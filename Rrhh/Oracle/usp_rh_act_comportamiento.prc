create or replace procedure usp_rh_act_comportamiento (asi_nada in string) is
  ...
  for rc_com in c_competencias loop
    ...
    if ln_contador = 0 then
      ...
      insert into rh_evaluacion_personal_det (
        ...
        cod_comport, puntaje,flag_replicacion )
      values (
        ld_fecha_evaluacion, ls_cod_trabajador, ls_cod_competencia,
        ls_cod_comportamiento, 0, '1') ;
