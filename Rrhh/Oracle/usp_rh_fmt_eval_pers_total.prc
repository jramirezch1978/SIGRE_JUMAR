create or replace procedure usp_rh_fmt_eval_pers_total is

ls_nombre_trabajador      varchar2(120) ;
ls_nombre2                maestro.nombre2%type ;
  
--  Lectura de cargos reales del trabajador
cursor c_evaluacion_cab is 
  ...
  where cr.flag_estado = '1' and cr.cod_trabajador = m.cod_trabajador and
...
--  Lectura de comportamientos y competencias
...
--  ************************************************************************
--  ***   FORMATO DE EVALUACION DE DESEMPENO DE TODOS LOS TRABAJADORES   ***
--  ************************************************************************

delete tt_eval_desempeno_det ;
delete tt_eval_desempeno_cab ;

for rc in c_evaluacion_cab loop
...
end usp_rh_fmt_eval_pers_total ;
/
