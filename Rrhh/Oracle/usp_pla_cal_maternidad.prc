create or replace procedure usp_pla_cal_maternidad
...
ls_tipo_ina        char(3);
lk_gan_fij         constant char(3) := '096';
ls_concep_mat      concepto.concep%type;
...
--  Calcula maternidad si tiene dias
If ln_diatra > 0 then
  ...
  For rc_c in c_concepto ( ls_concep_mat ) Loop
