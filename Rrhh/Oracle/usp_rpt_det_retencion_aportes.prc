create or replace procedure usp_rpt_det_retencion_aportes
( as_ano in char ) is
...
--  Lectura de todos los trabajadores activos a la fecha
cursor c_maestro is 
...
--  ******************************************************
--  ***   LECTURA DE TRABAJADORES ACTIVOS A LA FECHA   ***
--  ******************************************************
ln_item := 0 ; ln_sw := 0 ;
for rc_mae in c_maestro loop
  ...
  if ln_imp_total <> 0 then                  
    ...
    insert into tt_det_retencion_aportes (
      periodo, quiebre, codtra, nombre_afp, item,
      nro_afp_ipss, paterno, materno, nombre1, nombre2,
      imp01, imp02, imp03, imp04, imp05, imp06,
      imp07, imp08, imp09, imp10, imp11, imp12, fec_cese )
    values (
      as_ano, ls_quiebre, ls_codigo, ls_nombre_afp, ln_item,
      ls_afp_ipss, rc_mae.apel_paterno, rc_mae.apel_materno, rc_mae.nombre1, rc_mae.nombre2,
      ln_imp01, ln_imp02, ln_imp03, ln_imp04, ln_imp05, ln_imp06,
      ln_imp07, ln_imp08, ln_imp09, ln_imp10, ln_imp11, ln_imp12, rc_mae.fec_cese ) ;
  else
    ln_item := ln_item - 1 ;
  end if ;
...
end usp_rpt_det_retencion_aportes ;
/
