create or replace procedure usp_rh_liq_rpt_aportaciones (
...
--  Lectura de movimiento de aportaciones patronales
cursor c_detalle is
...
--  **************************************************************
--  ***   TEMPORAL PARA GENERAR LIQUIDACION POR APORTACIONES   ***
--  **************************************************************

delete from tt_liq_rpt_aportaciones ;
...
for rc_grp in c_grupos loop
  ...
  for rc_det in c_detalle loop
    ...
    insert into tt_liq_rpt_aportaciones (
...
end usp_rh_liq_rpt_aportaciones ;
/
