...
if nvl(ani_dias_trabaj,0) > 0 then
   ...
   IF ls_flag_tipo_sueldo = 'J' THEN
      ...
      -- Calculo de compensación de horas según indicador
      if ls_flag_comp_hrs = '1' then
     ...
     */
     ln_acum_grat := 0;
      ...
      for rc_gan in c_AsigFamiliar loop
          ...
          /*  Cambio Realizado el día 01/03/2014 a solicitud de CEPIBO, la asignación familiar sera la quincenal sin importar
              los días laborados
